...
class Ins{
	...
	public Ins(String policyNumber, String insuranceProvider, double coverageAmount, String coverageType,
			int durationinYears) {
		super();
		this.policyNumber = policyNumber;
		this.insuranceProvider = insuranceProvider;
...
public class Prac {
	public static Ins extractDetails(String details) {
		String [] d=details.split(":");
		if(d.length==5) {
			return new Ins(d[0],d[1],Double.parseDouble(d[2]),d[3],Integer.parseInt(d[4]));
		}
		else {
			return null;
		}
	...
	public static void main(String[] args) {
		...
		Ins insurance =extractDetails(details);
